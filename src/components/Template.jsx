  ...
  if (theme === 'red') {
    return (
      <div className="flex min-h-screen w-full items-center justify-center px-4">
        <form
          onSubmit={onSubmit}
          className="w-full h-auto min-w-xl sm:max-w-md md:max-w-lg flex flex-col justify-between border border-[#ff4d4f] rounded-2xl p-4 sm:p-6 md:p-10 bg-white shadow-lg md:min-h-[60vh]"
        >
          <div>
