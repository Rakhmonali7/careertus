...
export default function SalaryRangeSelector() {
  ...
  return (
    <div className="flex items-end gap-2 flex-wrap -m-8">
      {/* Currency Dropdown */}
      <div>
        <select
          value={currency}
          onChange={e => setCurrency(e.target.value)}
          className="border rounded-full px-2 py-2 focus:outline-none"
        >
          {currencies.map(cur => (
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="border rounded-full pl-8 pr-4 py-1.5 w-32 focus:outline-none"
          />
        </div>
      </div>
